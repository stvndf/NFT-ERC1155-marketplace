  ...
  describe("Single token marketplace", () => {
    ...
    context("buySingleToken function", async () => {
      it("Reverts as expected", async () => {
        ...
        await expectRevert.unspecified(
          contract.buySingleToken(0)); // non-existent token
        await contract.mintToken(0, 1, 1);
...
// it('z', async () => {
//           await contract.mintToken(0, 1, 2);
//           await contract.mintToken(1, 1, 300);
//           await contract.mintToken(2, 1, 1);
//           await contract.mintToken(3, 1, 3);


//           await contract.setPackPrice(web3.utils.toWei("1"));
//           await contract.setForPackSale(0, 1);
//           await contract.setForPackSale(1, 300);
//           // await contract.setForPackSale(2, 1);
//           // await contract.setForPackSale(3, 1);
//   await contract.z({value: web3.utils.toWei("1")});
//   // await contract.z();
//   // await contract.z();
//   // await contract.z();
// })
